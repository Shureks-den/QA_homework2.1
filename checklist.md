...
8.  Страница создания объявления. Создание нового объявления при данных - Название: тест, выбор категории: последняя в списке, описание: 'это описание', цена: 100, загрузка фотографии test.jpeg, клик по карте. Редирект на страницу продвижения этого объявления */ad/{id}/updrage после клика по кнопке `опубликовать`.
