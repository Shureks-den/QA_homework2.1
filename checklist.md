...
12. Страница профиля. Корзина. Нажатие на кнопку `удалить` добавит элемент удаления ко всем карточкам объявлений на странице.
13. Страница профиля. Корзина. Нажатие на элемент удаления на карточке удалит это объявление из грида.
14. Страница профиля. Корзина. Нажатие на кнопку 'купить' на карточке покажет модальное окно с информацией о товаре.
15. Страница профиля. Платные услуги. Отображается грид с активными объявлениями, клик по первому ведет на страницу */ad/{id}/updrage
16. Страница профиля. Чат. Нажатие на элемент диалога ведет на страницу */chat/{id}/{id}
17. Страница профиля. Чат. Ввести в инпут 'test' и нажать на кнопку отправить. В окне чата добавится новый блок с сообщением. 
18. Страница профиля. Настройки. Загрузка аватара через специальный инпут изменит изображение в навбаре.
19. Страница профиля. Настройки. Загрузка аватара через специальный инпут изменит изображение в информационном блоке профиля.
20. Страница профиля. Настройки. Нажатие кнопки изменить пароль при пустых инпутах старого и нового паролей сделает инпут нового пароля некорректным.
21. Страница профиля. Настройки. Нажатие кнопки изменить пароль при пустом инпуте старого пароля сделает форму старого пароля некорректной
22. Страница профиля. Настройки. Нажатие кнопки изменить пароль при неверном инпуте 'notpassword' старого пароля сделает инпут старого пароля некорректным.
23. Страница профиля. Настройки. Нажатие кнопки изменить пароль при  инпуте 'password' старого пароля и нового пароля - 'a' сделает инпут нового пароля некорректным.
24. Страница профиля. Настройки. Нажатие кнопки изменить пароль при  инпуте 'password' старого пароля и нового пароля - 'password' сделает инпут нового пароля некорректным.
25. Страница профиля. Настройки. Нажатие кнопки изменить пароль при  инпуте 'password' старого пароля и нового пароля - 'password1' сделает инпуты паролей корректными и изменит текст кнопки на `пароль изменен`.
26. Страница профиля. Настройки. Нажатие кнопки изменить информацию при пустой форме редактирования информации о профиле не изменяет инпуты.
27. Страница профиля. Настройки. Нажатие кнопки изменить информацию при следующих данных имя: 'a' фамилия: '' телефон: '' сделает инпут имени некоррентным.
28. Страница профиля. Настройки. Нажатие кнопки изменить информацию при следующих данных имя: 'aa' фамилия: 'a' телефон: '' сделает инпут фамилии некоррентным.
29. Страница профиля. Настройки. Нажатие кнопки изменить информацию при следующих данных имя: 'aa' фамилия: 'aa' телефон: '' изменит имя в навбаре.
30. Страница профиля. Настройки. Нажатие кнопки изменить информацию при следующих данных имя: 'aa' фамилия: 'aa' телефон: '' изменит имя в информационном блоке.
31. Страница профиля. Настройки. Нажатие кнопки изменить информацию при следующих данных имя: 'aa' фамилия: 'aa' телефон: '' сделает все инпуты в форме коррекнтными и текст кнопки изменится на 'информация сохранена'.
32. Страница профиля. Настройки. Нажатие кнопки изменить информацию при следующих данных имя: '' фамилия: '' телефон: '+7(322)323-123' не изменит инпуты.
33. Страница профиля. Настройки. Нажатие кнопки изменить информацию при следующих данных имя: '' фамилия: '' телефон: '+7(322)111-11-11' сделает все инпуты в форме коррекнтными и текст кнопки изменится на 'информация сохранена'.
